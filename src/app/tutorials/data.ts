...
export const tutorialsDatabase: Record<string, Tutorial> = {
  'node-js-quickstart': {
    id: 'node-js-quickstart',
    title: 'Optimizing Your First Prompt in Node.js (Next.js & Express)',
    difficulty: 'Beginner',
    timeToComplete: '5 min read',
    category: 'Next.js / Vercel',
    excerpt: 'An entry-level guide to installing the dependency stack, initializing the compression controller, and trimming your first payload string natively.',
    prerequisites: ['Node.js Runtime Engine (v18+)', 'SiftPrompt Account Subscription Token', 'Basic understanding of JavaScript async/await functions'],
    steps: [
      {
        num: '01',
  ...
  'python-quickstart': {
    ...
    category: 'Python',
    excerpt: 'A clean, dependency-light script utilizing SiftPrompt alongside native client wrappers to trim syntax padding and track optimization efficiency.',
    prerequisites: [
  ...
  'fixing-quadratic-token-tax': {
    id: 'fixing-quadratic-token-tax',
    title: 'Fixing the "Quadratic Token Tax" in Multi-Turn LangChain Agents',
    difficulty: 'Intermediate',
    timeToComplete: '12 min read',
    category: 'Architecture',
    excerpt: 'Stop paying models to re-read repetitive memory frames. Learn how to drop an inline garbage collection compiler layer directly into active LangGraph runtime loops.',
    prerequisites: [
  ...
  'budget-friendly-rag-pipelines': {
    id: 'budget-friendly-rag-pipelines',
    title: 'Building a Budget-Friendly RAG Pipeline with Token Sifting',
    difficulty: 'Intermediate',
    timeToComplete: '15 min read',
    category: 'Architecture',
    excerpt: 'Vector databases often return high-noise context. Learn how to clean, compress, and deduplicate structural document context pools prior to LLM compilation to drastically reduce costs.',
    prerequisites: [
  ...
  'deploying-on-edge-infrastructure': {
    id: 'deploying-on-edge-infrastructure',
    title: 'Deploying SiftPrompt on Vercel Edge Functions or AWS Lambda',
    difficulty: 'Advanced',
    timeToComplete: '10 min read',
    category: 'Infrastructure',
    excerpt: 'Isolate minification to global edge networks. Intercept, condense, and forward streaming API requests in transit while maintaining zero execution latency.',
    prerequisites: [
    ...
    steps: [
      {
        ...
        codeSnippet: `// Deployment architecture scheme visualization:\n// Client Browser -> Vercel Edge Middleware (Runs SiftPrompt) -> OpenAI/Anthropic Api API Edge Host`
      },
      {
        num: '02',
  ...
  'real-time-cost-budget-alerts': {
    id: 'real-time-cost-budget-alerts',
    title: 'Setting up Real-Time Cost Budget Alerts & Telemetry Hubs',
    difficulty: 'Intermediate',
    timeToComplete: '8 min read',
    category: 'Infrastructure',
    excerpt: 'Configure a localized automated daemon system on Supabase to trap resource overruns and broadcast token metric savings directly to your operational communication nodes.',
    prerequisites: [
  ...
  'math-of-prompt-minification': {
    id: 'math-of-prompt-minification',
    title: 'The Math of Prompt Minification: Stemming & Structural Pruning',
    difficulty: 'Advanced',
    timeToComplete: '20 min read',
    category: 'Architecture',
    excerpt: 'An academic deep dive breaking down how our compiler strips structural white spaces, redundant grammar sub-tokens, and syntactic noise without breaking LLM reasoning bounds.',
    prerequisites: [
